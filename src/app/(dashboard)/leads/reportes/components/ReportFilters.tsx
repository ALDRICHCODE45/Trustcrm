...
export function ReportFilters({
  ...
  const [selectedGenerador, setSelectedGenerador] = useState<string>("all");
  ...
  const handleApplyFilters = () => {
    ...
    onFiltersChange({
      generadorId: selectedGenerador === "all" ? undefined : selectedGenerador,
    ...
    <Card className="p-6 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="generador">Generador de Leads</Label>
          <Select
            value={selectedGenerador}
            onValueChange={setSelectedGenerador}
          >
            <SelectTrigger>
